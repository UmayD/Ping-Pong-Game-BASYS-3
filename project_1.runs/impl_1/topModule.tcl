...
set rc [catch {
  ...
  add_files -quiet C:/Users/Umay/Desktop/Pong/project_1.runs/synth_1/topModule.dcp
...
set rc [catch {
  ...
  report_drc -file topModule_drc_routed.rpt -pb topModule_drc_routed.pb -rpx topModule_drc_routed.rpx
  report_methodology -file topModule_methodology_drc_routed.rpt -rpx topModule_methodology_drc_routed.rpx
...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile topModule.bit 
